...
export default function Recommendations({ implementedAreas, unImplementedAreas, areasLoading }) {
                    ...
                    <div className="font-semibold">Areas Implemented</div>
                    {
                        areasLoading ? (
                            ...
                            <div className="m-4 flex-grow flex justify-center items-center flex-wrap gap-4">
                                {
                                    (implementedAreas.length === 0 && unImplementedAreas.length === 0) ? (
                                        <div className="text-xl my-12 font-medium">No Recommendations</div>
                                    ) : (
                                        Object.keys(analysisResult).map((area, index) => (
                                            <div key={index} className="py-1 flex-1 basis-[calc(40%-16px)]">
                                                ...
                                                <div className="flex justify-center items-center gap-2 flex-nowrap m-1">
                                                    <LinearProgress
                                                        variant="determinate"
                    ...
                    </div>
                    {
                        areasLoading ? (
                            ...
                            <div>
                                {
                                    (implementedAreas.length === 0 && unImplementedAreas.length === 0) ? (
                                        <div className="text-xl my-12 font-medium text-center">No Recommendations</div>
                                    ) : (
                                        Object.keys(analysisResult).map((area, index) => {
                                            return (
                                                <Accordion
